  ...
  return (
    ...
    >
      <div className="relative w-full">
        {format && (
          <label className="block text-sm font-medium opacity-50 mt-2">
            CATEGORIA
          </label>
        )}
        ...
        >
          <span className="p-3 menu-hover font-medium text-white">
            {selectedOption
              ? selectedOption
              : format
              ? "CATEGORIA"
        ...
        {isOpen && (
          <div className="w-full h-[230px] rounded-md overflow-auto text-xs absolute top-full mt-1 bg-gray-900 text-gray-800 shadow-xl">
